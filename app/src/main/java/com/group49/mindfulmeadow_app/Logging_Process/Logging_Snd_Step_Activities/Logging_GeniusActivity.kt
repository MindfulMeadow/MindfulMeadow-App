...
class Logging_GeniusActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_logging_genius)

        mBtnBackToFst = findViewById(R.id.iv_back_to_fst)
        mRG1 = findViewById(R.id.rg_genius)
        mBtnNext = findViewById(R.id.btn_genius_next)
        et_others = findViewById(R.id.et_genius)


        mBtnBackToFst.setOnClickListener {
            val intent = Intent(this@Logging_GeniusActivity, Logging_fstActivity::class.java)
        ...
        mBtnNext.setOnClickListener {
            ...
            if (selectedRadioButtonId != -1 || othersText.isNotEmpty()) {
                ...
                val intent = Intent(this@Logging_GeniusActivity, Logging_thirdActivity::class.java).apply {
                    putExtra("selectedMood", "Genius: " + selectedText)
                }
                startActivity(intent)
                overridePendingTransition(R.anim.enter_anim, R.anim.exit_anim)
            } else {
